...
| WorkBuddy | User and project `.agents/skills` | Documented Skill ZIP with required metadata validation | Unavailable | Manual Add Skill > Upload Skill plan | Reimport prior reviewed ZIP | Adapter and fixture tests implemented; manual client verification required |
